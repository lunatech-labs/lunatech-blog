...
tags:
  ...
  - ios
  - react-native
img: images/media/2020-01-20-creating-an-android-and-ios-app-with-react-native/background.png
---
= Creating an Android and iOS App with React Native

:imagesdir: /images/media/2020-01-20-creating-an-android-and-ios-app-with-react-native
