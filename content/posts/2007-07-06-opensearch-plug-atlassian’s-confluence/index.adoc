...
(link:opensearch-description-example2.xml[example opensearch.xml])
...
. Customize the link:opensearch-description-example2.xml[opensearch.xml]
file.
...
link:opensearch-description-example1.xml[example opensearch.xml].
