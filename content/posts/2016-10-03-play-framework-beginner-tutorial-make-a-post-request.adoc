...
tags:
  ...
  - scala
  - mongodb
img: images/media/2016-10-03-play-framework---beginner-tutorial---make-a-post-request/background.png
aliases:
  - /posts/2016-10-03-play-framework---beginner-tutorial---make-a-post-request
---
= Play Framework - Beginner Tutorial - Make a post request and save the form data in Mongodb

:imagesdir: /images/media/2016-10-03-play-framework---beginner-tutorial---make-a-post-request
