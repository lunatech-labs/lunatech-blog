...
tags:
  ...
  - gcp
  - spark
img: images/media/2019-01-14-running-the-spark-notebook-on-a-kubernetes-google-cloud-cluster/background.png
---
= Running The Spark-Notebook On A Kubernetes Google Cloud Cluster

:imagesdir: /images/media/2019-01-14-running-the-spark-notebook-on-a-kubernetes-google-cloud-cluster
