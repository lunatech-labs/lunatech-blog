...
image:perfect-programmer.png[In search of the perfect programmer,link=/media/2010-03-16-presentations-drools-perfect-programmer/perfect-programmer.pdf]
image:decision-service.png[How to build a decision service using JBoss Rules (a.k.a. Drools),link=/media/2010-03-16-presentations-drools-perfect-programmer/decision-service.pdf]
