...
tags:
  ...
  - sbt
  - giblab
img: images/media/2016-08-01-continuous-integration-on-gitlab-with-sbt/background.png
---
= Continuous Integration on GitLab with Scala and SBT

:imagesdir: /images/media/2016-08-01-continuous-integration-on-gitlab-with-sbt
