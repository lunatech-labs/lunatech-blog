...
tags:
  ...
  - akka
  - scala
img: images/media/2020-06-08-announcing-the-moving-from-scala-2-to-scala-3-course/background.png
---
= Announcing the _Moving from Scala 2 to Scala 3_ course

:imagesdir: /images/media/2020-06-08-announcing-the-moving-from-scala-2-to-scala-3-course
