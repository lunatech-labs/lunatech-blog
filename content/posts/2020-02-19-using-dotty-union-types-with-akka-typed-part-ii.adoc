...
tags:
  ...
  - akka
  - scala
img: images/media/2020-02-19-using-dotty-union-types-with-akka-typed-part-II/background.png
aliases:
  - /posts/2020-02-19-using-dotty-union-types-with-akka-typed-part-II
---
= Using Dotty Union types with Akka Typed - Part II

:imagesdir: /images/media/2020-02-19-using-dotty-union-types-with-akka-typed-part-II
