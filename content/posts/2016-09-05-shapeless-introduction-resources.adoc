...
tags:
  - shapeless
  - scala
img: images/media/2016-09-05-shapeless---introduction-resources/background.png
aliases:
  - /posts/2016-09-05-shapeless---introduction-resources
---
= Shapeless - Introduction resources

:imagesdir: /images/media/2016-09-05-shapeless---introduction-resources
