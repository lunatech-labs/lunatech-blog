...
tags:
  ...
  - scala
  - monad
img: images/media/2016-10-31-side-effects-and-how-to-deal-with-them/background.png
---
= Side Effects and How To Deal With Them The Cool Way, Part 2 - Monads Introduction

:imagesdir: /images/media/2016-10-31-side-effects-and-how-to-deal-with-them
