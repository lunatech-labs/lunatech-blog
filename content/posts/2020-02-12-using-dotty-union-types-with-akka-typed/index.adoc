...
image::PingPongActors.png[{in-between-width}]
...
image::PingPongProtocol-1.png[{in-between-width}]
...
image::PingPongProtocol-2.png[{in-between-width}]
...
[#img-DottyUnionTypes]
image::Union_types_-_definition.png[{in-between-width},align='center']
...
image::PingPongProtocol-3.png[{in-between-width}]
