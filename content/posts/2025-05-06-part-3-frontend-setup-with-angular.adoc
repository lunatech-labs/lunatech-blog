...
tags:
  ...
  - typescript
  - nodejs
img: images/media/2025-05-06-part-3-frontend-setup-with-angular/background.png
aliases:
  - /posts/2025-05-06-part-3-frontend-setup-with-angular
---
= Part 3: Frontend Setup with Angular

:imagesdir: /images/media/2025-05-06-part-3-frontend-setup-with-angular
