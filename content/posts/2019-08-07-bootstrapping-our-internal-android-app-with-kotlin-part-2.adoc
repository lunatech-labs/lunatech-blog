...
tags:
  - ktor
  - kotlin
img: images/media/2019-08-07-bootstrapping-our-internal-android-app-with-kotlin-part-2/background.png
---
= Bootstrapping Our Internal Android App With Kotlin (Part 2)

:imagesdir: /images/media/2019-08-07-bootstrapping-our-internal-android-app-with-kotlin-part-2
