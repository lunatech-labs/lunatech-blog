...
tags:
  - ktor
  - kotlin
img: images/media/2019-06-19-bootstrapping-our-internal-android-app-with-kotlin/background.png
---
= Bootstrapping Our Internal Android App With Kotlin

:imagesdir: /images/media/2019-06-19-bootstrapping-our-internal-android-app-with-kotlin
