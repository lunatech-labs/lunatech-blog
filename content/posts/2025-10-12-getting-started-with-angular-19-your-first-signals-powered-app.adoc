...
tags:
  ...
  - signals
  - reactive state
img: images/media/2025-10-12-getting-started-with-angular-19--your-first-signals-powered-app/background.png
aliases:
  - /posts/2025-10-12-getting-started-with-angular-19--your-first-signals-powered-app
---
= Getting Started with Angular 19: Your First Signals-Powered App

:imagesdir: /images/media/2025-10-12-getting-started-with-angular-19--your-first-signals-powered-app
