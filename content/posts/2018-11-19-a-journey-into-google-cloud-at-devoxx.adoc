...
tags:
  - event
img: images/media/2018-11-19-a-journey-into-google-cloud-at-devoxx/background.png
---
= A Journey Into Google Cloud At Devoxx

:imagesdir: /images/media/2018-11-19-a-journey-into-google-cloud-at-devoxx
