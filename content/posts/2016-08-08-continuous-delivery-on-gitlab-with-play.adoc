...
tags:
  ...
  - playframework
  - sbt
img: images/media/2016-08-08-continuous-delivery-on-gitlab-with-play/background.png
---
= Continuous Delivery on GitLab with Play, Scala, SBT and Heroku

:imagesdir: /images/media/2016-08-08-continuous-delivery-on-gitlab-with-play
