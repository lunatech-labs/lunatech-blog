...
tags:
  ...
  - streaming
  - scala
img: images/media/2019-11-15-lessons-learned-using-spark-structured-streaming/background.png
---
= Lessons Learned Using Spark Structured Streaming

:imagesdir: /images/media/2019-11-15-lessons-learned-using-spark-structured-streaming
