...
img: images/media/2025-10-27-getting-started-with-angular-20-cli-and-standalone-components/background.png
---
= Getting Started with Angular 20 CLI and Standalone Components

:imagesdir: /images/media/2025-10-27-getting-started-with-angular-20-cli-and-standalone-components
