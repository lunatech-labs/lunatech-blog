...
tags:
  ...
  - scala
  - monad
img: images/media/2016-10-17-side-effects-and-how-to-deal-with-them/background.png
---
= Side Effects and How To Deal With Them The Cool Way, Part 1 - Pure functions and functors

:imagesdir: /images/media/2016-10-17-side-effects-and-how-to-deal-with-them
