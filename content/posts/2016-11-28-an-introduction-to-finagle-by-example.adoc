...
tags:
  - finagle
  - scala
img: images/media/2016-11-28-an-introduction-to-finagle-by-example/background.png
---
= An Introduction to Finagle by example

:imagesdir: /images/media/2016-11-28-an-introduction-to-finagle-by-example
