...
image::differentthings.png[Diagram: each search result is a link to an item page{half-width}]
...
image::differentsearch.png[Diagram: search form checkboxes to select search results columns{half-width}]
...
image::differentresults.png[Diagram: checkboxes on search results page instead{half-width}]
