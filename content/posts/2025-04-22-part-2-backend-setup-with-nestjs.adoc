...
tags:
  ...
  - typescript
  - nodejs
img: images/media/2025-04-22-part-2-backend-setup-with-nestjs/background.png
aliases:
  - /posts/2025-04-22-part-2-backend-setup-with-nestjs
---
= Part 2: Backend Setup with NestJS

:imagesdir: /images/media/2025-04-22-part-2-backend-setup-with-nestjs
