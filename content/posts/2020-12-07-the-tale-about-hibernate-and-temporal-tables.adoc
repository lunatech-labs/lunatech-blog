...
tags:
  ...
  - temporal
  - mssql
img: images/media/2020-12-07-the-tale-about-hibernate-and-temporal-tables/background.png
---
= The tale about Hibernate and Temporal Tables

:imagesdir: /images/media/2020-12-07-the-tale-about-hibernate-and-temporal-tables
