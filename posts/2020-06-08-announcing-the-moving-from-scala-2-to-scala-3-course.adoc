...
In a nutshell, a _"studentified"_ version of the course is an artefact generated
...
This artefact is a self-contained sbt project that has special functionality built-in
...
quickly inspect the changes between subsequent exercises. This artefact also serves
...
The transformation to _"studentified"_  and _"linearized"_ artefacts is done by the
