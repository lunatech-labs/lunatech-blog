...
:imagesdir: ../media/2026-06-10-software-defined-vehicle-backend
:lang: en
...
video::https://github.com/lunatech-labs/sdv-fleet-management/raw/main/docs/screenshots/demo.mp4[width=720,opts=controls]
