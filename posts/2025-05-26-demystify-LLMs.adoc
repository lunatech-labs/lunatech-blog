...
image::../media/2025-05-26-demystify-LLMs/cotton-probability-machine-simple-compose.png[A caption, 900]
...
image::../media/2025-05-26-demystify-LLMs/cat_on_warm_mat_simple_compose.png[A caption, 900]
...
=== context
The surrounding words or sequences that inform next-word prediction. Context length varies by model type—<<bigram-models>> use 1 word, trigram models use 2 words, and <<n-gram-models>> use n-1 words of context.
