...
image::cotton-probability-machine-simple-compose.png[Embroidered probability machine, 900]
...
image::cat_on_warm_mat_simple_compose.png[Embroidered cat on an embroidered mat, 900]
