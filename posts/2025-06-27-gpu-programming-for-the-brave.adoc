...
:lang: en
:tags: [GPU programming, CUDA, parallel programming, AI, neural network]
...
[[card]]
.My Nvidia RTX 3080.
image::my_graphics_card_2.png[A,400,180]

[.right]
[[disassembled-card]]
.My Nvidia RTX 3080 (disassemble).
image::my_graphics_card_1.png[B,400,180]
--
...
image::gpu_architecture_1.png[A,240,180]

[.right]
.Nvidia's interpretation.
image::gpu_architecture_2.png[B,400,180]
--
...
[.text-center]
.Speed showcase.
image::speed_result.png[Speed showcase.,400,180]
--
...
[.text-center]
.A neural network.
image::neural_network.png[Speed showcase.,400,180]
--
...
image::neural_network_layer_c.png[Speed showcase.,300,180]

[.right]
[[cuda-implementation]]
.CUDA implementation of a neural network layer.
image::neural_network_layer_cuda.png[Speed showcase.,450,180]
--
